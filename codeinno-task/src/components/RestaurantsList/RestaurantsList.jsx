...
import RestaurantDataSave from "../../helper/localStorage";

export default function RestaurantsList({ getRestaurantsID }) {
  ...
  useEffect(() => {
    axios.get(requestUrl.GET_RESTAURANTS).then((resp) => {
      ...
      setIsLoading(true);
      RestaurantDataSave(sortedRestaurantData);
    });
  }, []);
                ...
                return (
                  <li key={restaurant.id} className="py-3 sm:py-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div
                        onClick={() => getRestaurantsID(restaurant.id)}
